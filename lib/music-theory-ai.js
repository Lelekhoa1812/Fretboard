...
export class MusicTheoryAI {
  ...
  static async analyzeProgressionVibe(progression, context = '', sessionId = null) {
    const prompt = `You are a creative music analyst with deep understanding of emotional impact in chord progressions.

    **Chord Progression:** ${progression}
    **Context:** ${context}

    **Generate a creative, personalized vibe analysis:**

    ## **Emotional Journey**
    - Describe the overall emotional arc of this progression
    ...
    Be creative, poetic, and inspiring. Focus on the emotional and artistic impact rather than technical theory.`;
  ...
  static async analyzeIndividualChord(chord, progression, position, totalChords, context = '', sessionId = null) {
    ...
    **Provide a comprehensive chord analysis in JSON format:**

    {
      "name": "${chord}",
      "emotion": "Brief emotional description (2-3 words)",
      "impact": "What this chord contributes to the progression",
      "explanation": "Detailed explanation of the chord's role and character",
    ...
    **Guidelines:**
    - Make the emotion description creative and specific to this chord's role
    - Explain how this chord fits into the overall progression
    - Provide practical fretboard positions for guitar
    - Suggest 3 alternative chords that could work in this position
    - Choose a color that matches the chord's emotional character
    - Be specific about finger positions and string numbers
    - Focus on the chord's unique contribution to the progression
  ...
  static async summarizeAnalysis(fullResponse, chordName, context = '', sessionId = null) {
    const prompt = `You are a concise music instructor. Summarize this detailed chord analysis into a brief, instructional format.

    **Chord:** ${chordName}
    **Context:** ${context}
    **Full Analysis:** ${fullResponse}

    **Create a concise summary (2-3 sentences max) that includes:**
    - The chord's emotional character
    - Its role in the progression
    ...
    **Guidelines:**
    ...
    - Preserve the most important musical insight
