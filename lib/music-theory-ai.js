...
export class MusicTheoryAI {
  ...
  static async generatePracticePlan(skillLevel, timeAvailable, focusArea, sessionId = null) {
    ...
    **CRITICAL: Return ONLY valid JSON. No additional text, explanations, or commentary.**
    ...
    **IMPORTANT:**
    ...
    - Include warmup, main practice, cooldown, and next steps
  ...
  static async analyzeScalePattern(scale, key, sessionId = null) {
    ...
    **IMPORTANT:**
    ...
    - No explanations, no additional text
    - Ensure valid JSON syntax
    - Provide accurate scale notes
    - Include practical fretboard positions
    - Suggest relevant chords and exercises`;
  ...
  static async analyzeIndividualChord(chord, progression, position, totalChords, context = '', sessionId = null) {
    ...
    **IMPORTANT:**
    ...
    - No explanations, no additional text
    - Ensure valid JSON syntax
    - Make emotions vivid and specific
    - Include proper fretboard positions
    - Provide creative alternative chords`;
