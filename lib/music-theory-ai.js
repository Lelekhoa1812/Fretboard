...
export class MusicTheoryAI {
  ...
  static async analyzeIndividualChord(chord, progression, position, totalChords, context = '', sessionId = null) {
    const prompt = `You are a passionate guitar instructor analyzing a specific chord within a chord progression.
    ...
    **Return JSON only:**
    {
      "name": "${chord}",
      "emotion": "Vivid emotional description (3-4 words)",
      "impact": "What this chord contributes to the progression",
      "explanation": "Rich explanation of the chord's role, character, and emotional journey",
      "alternatives": [
        {
