...
// =====================
// Movable shape system
// =====================
// We define ONE movable barre shape per quality and derive all roots by transposing along the fretboard.
// Positions below are offsets in FRETS from the baseFret on a given string.
// rootString indicates where the root is located for the movable shape (6th-string or 5th-string shapes).
...
// Base movable shapes by quality (E-shape barre by default)
// Offsets are relative fret distances from baseFret on each string.
// finger: suggested fingering; 1 denotes barre where appropriate.
const baseMovableShapesByQuality = {
  ...
  // Additional qualities can be added here following the same structure.
};
